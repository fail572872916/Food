...
//        List<FoodInfo> subList = list.subList(3, 8);    //获取子列表
//        mAdapter = new FoodStyle1Adapter(subList, getActivity());
...
//            tesxtSmall=bigList.get(1).getDescribe();
//        }
//        utils.display(urlBig,ib_big);
//        utils.display(urlSmall,ib_small);
