...
public class JsonUtils {
     ...
     * @return
     */
    public static String initSend(String flag, String ip, Object message, String operationCode, String heartBeat) {
    ...
    public static String jsonResolve(String json) {
        ...
        if (!TextUtils.isEmpty(receiveSocket.getOperationCode())) {
            message = String.valueOf(receiveSocket.getMessage());
        }
        return message;
     ...
     * @return
     */
    public static String useJpushJson(String js, String m1, String deskNo) {
